...
is in :mod:`alerts_bi.api.service`, which calls the same pipeline the command line calls.
"""
...
from alerts_bi.api.dependencies import GateDep, SettingsDep
from alerts_bi.api.negotiation import wants_html
from alerts_bi.api.schemas import OutputFile, RunOut, RunRequest, VolumeOut
from alerts_bi.api.service import resolve_outputs, start_run
