...
Building it surfaced one pre-existing defect, in how "the team's most recent run" was ordered. It is not a property of this surface — `alerts-bi report --team` was equally affected — so it is recorded with the other settled boundaries in section 7.6.
